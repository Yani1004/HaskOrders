...
public class RegistrationView {
    ...
    private void initializeUI() {
        ...
        panel.setBackground(new Color(255, 190, 60)); // Replaced UIConstants.BACKGROUND_COLOR
        frame.setContentPane(panel);

        JLabel title = new JLabel("HaskOrders Register", SwingConstants.CENTER);
        title.setFont(new Font("Arial", Font.BOLD, 24)); // Replaced UIConstants.HEADER_FONT
        ...
        JButton registerButton = createButton("Register", new Color(70, 130, 180)); // Replaced UIConstants.PRIMARY_COLOR
