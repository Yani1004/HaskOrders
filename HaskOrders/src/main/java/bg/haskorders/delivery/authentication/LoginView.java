...
import bg.haskorders.delivery.authentication.router.DashboardRouter;
import bg.haskorders.delivery.authentication.service.AuthenticationService;
...
public class LoginView {
    ...
    public LoginView(List<User> userList) {
        this.authService = new AuthenticationService(userList);
    ...
    private void openRegisterPage() {
        frame.dispose();
        new RegistrationView(Main.userList);
    }
