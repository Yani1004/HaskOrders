...
public class AdminPanel {
    ...
    private void createControlPanel() {
        ...
        String[] roles = {User.ROLE_CLIENT, User.ROLE_EMPLOYEE, User.ROLE_DELIVERER};
    ...
    private void refreshUserTable() {
        ...
        for (User user : usersList) {
            tableModel.addRow(new Object[]{
                    ...
                    user.getEmail(),
                    user.getRole(),
                    user.getRole().equals(User.ROLE_ADMIN) ? "Admin" : "Active"
            });
        }
    }
    ...
    private void updateUserRole(JComboBox<String> roleCombo) {
        ...
        if (selectedRow >= 0) {
            ...
            // Prevent self-demotion of primary admin
            if (username.equals("admin") && !newRole.equals(User.ROLE_ADMIN)) {
                JOptionPane.showMessageDialog(frame,
                        "Cannot change role of primary admin account!",
                        "Warning",
            ...
            for (User user : usersList) {
                if (user.getUsername().equals(username)) {
                    ...
                    tableModel.setValueAt(newRole.equals(User.ROLE_ADMIN) ? "Admin" : "Active", selectedRow, 4);
                    JOptionPane.showMessageDialog(frame,
